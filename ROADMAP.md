...
9. 🔶 **Build the corporate website** — Home, About Us, Companies, Our Work, Careers, and Contact Us are live in `apps/web`, built on the token-backed component set from `unda-design-os` (ADR-014). Three sections are intentionally left as honest placeholders pending real data: About's team bios, Our Work's case studies, and the contact form's backend — see `../DECISIONS.md` for why these weren't fabricated.
