  ...
  return (
    <>
      <section className="bg-neutral-900 pt-[7rem] pb-1200 md:pt-[9rem]">
        <Container>
          <Reveal>
            <span className="text-brand-accent text-caption uppercase">What we offer</span>
          </Reveal>
          ...
          <Reveal index={2}>
            <p className="mt-400 text-h4 text-neutral-400">
              Engage us for one service or the full arc from strategy to shipped product, the same
              team, the same standard, throughout.
            </p>
          </Reveal>
        </Container>
      </section>
