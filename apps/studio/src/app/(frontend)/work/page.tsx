...
import { type CaseStudy, getPayloadClient, getWorkGlobal } from "@/lib/payload";
...
export default async function WorkPage() {
  const [caseStudies, work] = await Promise.all([getCaseStudies(), getWorkGlobal()]);
