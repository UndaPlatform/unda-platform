  ...
  return (
    <section className="flex min-h-dvh flex-col justify-center bg-neutral-900 pt-[8.5rem] pb-1200 md:pt-[11rem]">
      <Container>
        ...
        <Reveal index={1}>
          <h1 className="mt-400">
            <span className="block whitespace-normal font-display font-bold text-[clamp(3.25rem,17vw,5rem)] text-neutral-0 uppercase leading-[0.92] tracking-tight sm:hidden">
              {headline}
            </span>
