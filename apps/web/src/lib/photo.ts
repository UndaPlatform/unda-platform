 ...
 * has actually been dropped in, otherwise null so callers can fall back to the ImageSlot
 * empty state. Lets real photography "just appear" once added, with no code change required.
 */
